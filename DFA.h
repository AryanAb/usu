...
namespace usu
{
	...
	{
	public:
   		enum Type {BREAK, CHAR, CONST, CONTINUE, ENUM, FLOAT, FOR, IF, INT, RETURN, VOID, WHILE, LPAREN, RPAREN, LBRACKET, RBRACKET, ASSIGN, EQ, NEQ, GE, GT, LT, LE, ARROW, MULT, PLUS, SUB, DIV, MOD, ID, NUM, COMMENT, WHITESPACE, ERROR};
