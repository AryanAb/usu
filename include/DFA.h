...
namespace usu
{
	...
	{
	public:
   		enum Token {BREAK, CHAR, CONST, CONTINUE, ENUM, FLOAT, FOR, IF, INT, RETURN, VOID, WHILE, LPAREN, RPAREN, LBRACKET, RBRACKET, ASSIGN, EQ, NEQ, GE, GT, LT, LE, ARROW, MULT, PLUS, SUB, DIV, MOD, ID, COMMENT, WHITESPACE, COMMA, STRING, ERROR};
